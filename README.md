...
The steps listed below assume you already have proper Jave and Maven environments setup on your device - for more information on this see here: [apache maven](https://maven.apache.org/install.html)
